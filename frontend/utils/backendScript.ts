...
export const getInstallerScript = () => {
  return `#!/bin/bash
...
app = Flask(__name__)
# FIX: Permissive CORS to allow browser connections
CORS(app, resources={r"/*": {"origins": "*"}}, methods=["GET", "POST", "OPTIONS"])

# Initialize PaddleOCR
print("Initializing PaddleOCR engine...")
try:
    # FIX: Explicitly disable GPU and verbose logging for stability
...
def process_ocr():
    try:
        ...
        # Run OCR
        # Note: cls=True removed to avoid kwargs conflict.
